...
\subparagraph{}\textit{Résoudre numériquement l'équation différentielle pour $\theta(0)=\dfrac{\pi}{3}$ et $\dot{\theta}(0)=0$.}


\section*{Mise en situation du problème ed thermique}
\ifprof
\else
\vspace{.25cm}
