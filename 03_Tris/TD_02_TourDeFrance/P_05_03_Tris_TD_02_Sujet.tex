...
\def\xxsourceexo{Patricia Bessonnat \& Xavier Pessoles}%\hspace{.2cm} Informatique pour tous en CPGE -- \textit{Wack \& al.}}
...
\hline
\begin{center}
\textbf{Pour l'ensemble de ce TD, il sera nécessaire de télécharger et décompresser le fichier \url{https://goo.gl/cxjnS3} (aussi disponible via le site de la classe).}
\end{center}\\
\hline
\end{tabular}
\end{center}
