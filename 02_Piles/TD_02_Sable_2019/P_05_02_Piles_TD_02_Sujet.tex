...
\def\xxfigures{\includegraphics[width=.3\linewidth]{images/sablier_p}}%figues de la page de garde
...
\def\xxtitreexo{Sablier}
\def\xxsourceexo{\hspace{.2cm} Xavier Pessoles}
...
\input{P_05_02_Piles_TD_02_Sable_2019.tex}
